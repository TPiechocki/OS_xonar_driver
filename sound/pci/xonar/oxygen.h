...
void xonar_write8_masked(struct xonar *chip, unsigned int reg,
			  u8 value, u8 mask);
void xonar_write16_masked(struct xonar *chip, unsigned int reg,
			   u16 value, u16 mask);
void xonar_write32_masked(struct xonar *chip, unsigned int reg,
			   u32 value, u32 mask);

u16 xonar_read_ac97(struct xonar *chip, unsigned int codec,
		     unsigned int index);
void xonar_write_ac97(struct xonar *chip, unsigned int codec,
		       unsigned int index, u16 data);
void xonar_write_ac97_masked(struct xonar *chip, unsigned int codec,
			      unsigned int index, u16 data, u16 mask);

int xonar_write_spi(struct xonar *chip, u8 control, unsigned int data);
void xonar_write_i2c(struct xonar *chip, u8 device, u8 map, u8 data);

void xonar_reset_uart(struct xonar *chip);
void xonar_write_uart(struct xonar *chip, u8 data);

u16 xonar_read_eeprom(struct xonar *chip, unsigned int index);
void xonar_write_eeprom(struct xonar *chip, unsigned int index, u16 value);

static inline void xonar_set_bits8(struct xonar *chip,
				    unsigned int reg, u8 value)
{
	xonar_write8_masked(chip, reg, value, value);
}

static inline void xonar_set_bits16(struct xonar *chip,
				     unsigned int reg, u16 value)
{
	xonar_write16_masked(chip, reg, value, value);
}

static inline void xonar_set_bits32(struct xonar *chip,
				     unsigned int reg, u32 value)
{
	xonar_write32_masked(chip, reg, value, value);
}

static inline void xonar_clear_bits8(struct xonar *chip,
				      unsigned int reg, u8 value)
{
	xonar_write8_masked(chip, reg, 0, value);
}

static inline void xonar_clear_bits16(struct xonar *chip,
				       unsigned int reg, u16 value)
{
	xonar_write16_masked(chip, reg, 0, value);
}

static inline void xonar_clear_bits32(struct xonar *chip,
				       unsigned int reg, u32 value)
{
	xonar_write32_masked(chip, reg, 0, value);
}

static inline void xonar_ac97_set_bits(struct xonar *chip, unsigned int codec,
					unsigned int index, u16 value)
{
	xonar_write_ac97_masked(chip, codec, index, value, value);
}

static inline void xonar_ac97_clear_bits(struct xonar *chip,
					  unsigned int codec,
					  unsigned int index, u16 value)
{
	xonar_write_ac97_masked(chip, codec, index, 0, value);
}
