...
// CS4398 (front output, 2-channel DAC) bit masks for control registers
// SPECSHEET: https://statics.cirrus.com/pubs/proDatasheet/CS4398_F2.pdf#page=29
/* SPDX-License-Identifier: GPL-2.0 */
...
/* register 2 */
// FM means functional mode
#define CS4398_FM_MASK		0x03
// Single speed mode (30-50kHz)
...
// Digital mode (DSD mode)
#define CS4398_FM_DSD		0x03

// De-Emphasis Control for specific filter for different sample rates, available only in single speed mode
...
// In PCM mode, means left-justified data, it's default mode with up to 24-bit data
...
// invert signal polarity of B/A
#define CS4398_INVERT_B		0x20
#define CS4398_INVERT_A		0x40
// equal volume level on both front outputs
#define CS4398_VOL_B_EQ_A	0x80


/* register 4 */
// Mute Polarity (idk what it means)
#define CS4398_MUTEP_MASK	0x03
// auto detect, from AMUTEC pin
...
// MUTEC A and B pins are equal, these are mute control output pins
...
/* register 7 */
// Direct DSD conversion - not needed for me
#define CS4398_DIR_DSD		0x01
// select interpolation filter; set with slow roll off, 0 is fast roll off
#define CS4398_FILT_SEL		0x04
// soft ramp-down before filter mode change; soft mute and unmute on filter mode change if bit is set
#define CS4398_RMP_DN		0x10
// soft unmute after error
#define CS4398_RMP_UP		0x20
// big explanation in specsheet
// zero cross means that signal-level changes will happen when signal cross zero to minimize audible artifacts
#define CS4398_ZERO_CROSS	0x40
// signal-level changes are made in smaller steps
...
// CS4362A (rest of the outputs, 6-channel DAC)
/* SPDX-License-Identifier: GPL-2.0 */
// SPECSHEET: https://statics.cirrus.com/pubs/proDatasheet/CS4362A_F2.pdf#page=32
/* register 01h */
